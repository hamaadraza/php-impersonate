...
$lines = [
    ...
    '# Written by scripts/record-upstream-checksums.php. bin/CHECKSUMS records the',
    '# files as committed (stripped); this records what they came from, so a bundled',
    '# binary can be re-derived from upstream and checked:',
    '#',
    ...
    '#   strip --strip-unneeded <member> (Linux only)      # then must equal bin/CHECKSUMS',
    '#',
